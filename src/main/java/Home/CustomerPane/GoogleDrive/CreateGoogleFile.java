...
public class CreateGoogleFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.io.File uploadFile = new java.io.File("C://WarrantySystem/QRCodes/002005020fdgfghf.png");

        // Create Google File:

        File googleFile = createGoogleFile("1NAd_SrsYYhNQaaXpKwT80jS500PNU5iY", "image/png", "newfile.png", uploadFile);


        System.out.println("Created Google file!");
        System.out.println("WebContentLink: " + googleFile.getWebContentLink() );
        System.out.println("WebViewLink: " + googleFile.getIconLink() );
